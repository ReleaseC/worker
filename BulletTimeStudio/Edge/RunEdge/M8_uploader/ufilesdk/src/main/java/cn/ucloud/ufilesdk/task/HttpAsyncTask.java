...
public class HttpAsyncTask extends AsyncTask<Object, Object, Object> {
    ...
    public HttpAsyncTask(String url, UFileRequest uFileRequest, HttpCallback callback) {
        this.url = url;
        Log.i(TAG, "HttpAsyncTask this.url:" + this.url);
        this.uFileRequest = uFileRequest;
        Log.i(TAG, "HttpAsyncTask this.uFileRequest:" + this.uFileRequest);
    ...
    protected Object doInBackground(Object... params) {
        ...
        Log.i(TAG, "doInBackground authorization: " + authorization);
        ...
        try {
            ...
            Log.i(TAG, "conn.getRequestProperty: " + conn.getRequestProperty("Content-Type"));
            ...
            Log.i(TAG, "response_length: " + response_length);
            Log.i(TAG, "conn.getRequestProperty2: " + conn.getRequestProperty("Content-Type"));
    ...
    protected String getAuthorization(UFileRequest uFileRequest) {
        ...
        Log.i(TAG, "getAuthorization url:" + url);
        HttpURLConnection conn = null;
