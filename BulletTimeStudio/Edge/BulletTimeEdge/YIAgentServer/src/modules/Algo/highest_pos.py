...
sys.path.append('/home/siiva/project/BulletTimeStudio/BulletTime/bullet_localserver/src/modules/Algo/IntelligentVideoAnalytics/IVALIB')
...
for num in range(0, 20000):
    ...
    for ii in inds:
        ...
        cv2.imwrite(osp.join(args.output_dir, str(num) + '.jpg'), frame[:,:,::-1])
