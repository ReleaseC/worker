...
@Component({
  selector: 'app-GYMVertical_result',
  templateUrl: './GYMVertical_result.component.html',
  styleUrls: ['./GYMVertical_result.component.css'],
})
@Injectable()
export class GYMVertical_ResultComponent implements OnInit {
  ...
  async ngOnInit() {
    ...
    if(this.id==undefined||this.is_share=='siiva'){
      window.location.href='https://open.weixin.qq.com/connect/oauth2/authorize?appid=wxb0c9caded7e8fc8d&redirect_uri=https%3a%2f%2fiva.siiva.com%2fwechat%2fget_payid&response_type=code&scope=snsapi_base&state=SiivaPage,GYMVertical_result,'+this.taskId+','+this.activity_id+','+this.HK_id+'&connect_redirect=1#wechat_redirect';
    }else{
