...
export class AppComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    console.log(url)
    this.http
    .get(environment.apiServer+'wechat/get_jsapi_ticket', { params: { 'url':url,'siteId':'0011'} })
    .subscribe(data => {
      var user_id = this.id;
      ...
      wx.ready(function(){
        ...
        wx.onMenuShareTimeline({
            title: '“为爱行走·微笑杭州”之“时光子弹”', // 分享标题
            link:"https://bt.siiva.com/0011/#/result?id="+user_id+'&videonames='+videonames+'&name='+username+'&is_share=siiva',
            imgUrl: "http://siiva.ufile.ucloud.com.cn/wechat_0011.png", // 分享图标
            success:function(){
                // 用户确认分享后执行的回调函数
        ...
        wx.onMenuShareAppMessage({
          title: '“为爱行走·微笑杭州”之“时光子弹”', // 分享标题
          desc: '快来看看我在杭州拍摄的"时光子弹"视频，为我点赞哦', // 分享描述
          link: "https://bt.siiva.com/0011/#/result?id="+user_id+'&videonames='+videonames+'&name='+username+'&is_share=siiva', // 分享链接，该链接域名或路径必须与当前页面对应的公众号JS安全域名一致
          imgUrl: "http://siiva.ufile.ucloud.com.cn/wechat_0011.png", // 分享图标
