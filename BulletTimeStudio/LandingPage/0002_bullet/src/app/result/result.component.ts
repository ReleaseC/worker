...
export class ResultComponent implements OnInit {
  ...
  async ngOnInit() {
    ...
    if (this.is_share === 'siiva') {
         window.location.href='https://open.weixin.qq.com/connect/oauth2/authorize?appid=wxb0c9caded7e8fc8d&redirect_uri=https%3a%2f%2fbt.siiva.com%2fwechat%2fis_user&response_type=code&scope=snsapi_base&state='+this.id+','+this.videonames+','+this.username+',0,'+'0002&connect_redirect=1#wechat_redirect';
    }
    if(this.isplay==='no'){
    ...
    if(this.videonames!=='undefined'){
    this.video_url = 'https://siiva.cn-sh2.ufileos.com/ucloud/0012_1_0002_'+this.id+'_'+this.videonames.split('_')[this.videonames.split('_').length-1]+'.mp4';
