...
export class TempletComponent implements OnInit {
  ...
  this.http
  .get(`${environment.apiServer}wechat/get_video_name`, { params: { 'siteId': '0002', 'openid': this.id } })
  .subscribe(data => {
    console.log(data)
    console.log(data['description'])
    console.log(data['name'])
    if(data['description']!==undefined&&data['name']!==undefined){
      this.templet1_video_url='0012_1_0002_'+data['name']+'_'+data['description'];
      this.templet2_video_url='0012_2_0002_'+data['name']+'_'+data['description'];
      this.templet3_video_url='0012_3_0002_'+data['name']+'_'+data['description'];
      this.templet4_video_url='0012_4_0002_'+data['name']+'_'+data['description'];
      this.templet5_video_url='0012_5_0002_'+data['name']+'_'+data['description'];
      this.templet6_video_url='0012_6_0002_'+data['name']+'_'+data['description'];
    ...
    this.http
    .get(`${environment.apiServer}wechat_payment/get_users_order`, { params: { 'siteId': '0002', 'openid': this.id,'taskId':this.taskId } })
    .subscribe(data => {
      console.log(data)
