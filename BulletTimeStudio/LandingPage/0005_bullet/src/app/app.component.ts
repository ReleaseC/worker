    ...
    .subscribe(data => {
      ...
      wx.ready(function(){
        ...
        wx.onMenuShareTimeline({
            title: '金东乡村绿道马拉松时光子弹', // 分享标题
            link:"https://bt.siiva.com/0005/#/result?id="+user_id+'&videonames='+videonames+'&name='+username+'&is_share=siiva',
            imgUrl: "http://siiva.ufile.ucloud.com.cn/wechat_0005.png", // 分享图标
            success:function(){
                // 用户确认分享后执行的回调函数
                // alert('分享成功');
                this.isbar1=true;
        ...
        wx.onMenuShareAppMessage({
          title: '金东乡村绿道马拉松时光子弹', // 分享标题
          desc: '快来看看我的金东绿道马拉松时光子弹视频，为我点赞哦', // 分享描述
          link: "https://bt.siiva.com/0005/#/result?id="+user_id+'&videonames='+videonames+'&name='+username+'&is_share=siiva', // 分享链接，该链接域名或路径必须与当前页面对应的公众号JS安全域名一致
          imgUrl: "http://siiva.ufile.ucloud.com.cn/wechat_0005.png", // 分享图标
