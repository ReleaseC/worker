...
# 直接使用右侧ROI：python3 y1.py 1_1.mp4 out_1.mp4 3400 350 400 400 8 1080 1920
...
# 大喇叭第二个机位，第二个画面
#@profile
def saveRegion2(cap, videoWriter):
    global frameH, frameW, ex,ey,ew,eh, ex1,ey1,ew1,eh1, ow, oh
    ...
    while ret:
        ...
        if not IS_DETECTED1:
            ...
            # 检测到黄色皮筏出现
                IS_DETECTED1 = True
                print(cosin1)
                f_cnt1 = saveRegion2(cap,videoWriter)
