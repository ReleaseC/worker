import {weparkHttpClientBuckets, weparkHttpClientCallback} from "./httpclient.interface";
...
class HttpClient {
    ...
    private bucket: weparkHttpClientBuckets;
     ...
     */
    private useBucket(bucket: weparkHttpClientBuckets) {
        // 当桶发生切换时更新设定
     ...
     */
    public list(callback: weparkHttpClientCallback, bucket?: weparkHttpClientBuckets) {
        this.useBucket(bucket || weparkHttpClientBuckets.PRIVATE_BUCKET); //  默认列出私有桶文件列表
        this.client.list()
     ...
     */
    public put(originFileName: string, localFileName: string, callback: weparkHttpClientCallback,
               bucket?: weparkHttpClientBuckets) {
        this.useBucket(bucket || weparkHttpClientBuckets.PUBLIC_BUCKET);  //  默认上传到公共桶
     ...
     * @param {HttpClientBuckets} bucket 桶
     */
    public breakPointUpload(originFileName: string, localFileName: string, callback: weparkHttpClientCallback,
        times?: number, bucket?: weparkHttpClientBuckets) {

        this.useBucket(bucket || weparkHttpClientBuckets.PUBLIC_BUCKET);   //  设定上传默认使用公共桶
     ...
     */
    public get(originFileName: string, localFileName: string, callback: weparkHttpClientCallback,
               times?: number, bucket?: weparkHttpClientBuckets) {
        this.useBucket(bucket || weparkHttpClientBuckets.PRIVATE_BUCKET); //  获取默认使用私有桶
     ...
     * @param {HttpClientCallback} callback
     */
    public delete(originFileName: string, callback: weparkHttpClientCallback,
                  bucket?: weparkHttpClientBuckets) {
        this.useBucket(bucket || weparkHttpClientBuckets.PUBLIC_BUCKET);  //  默认删除公共桶
